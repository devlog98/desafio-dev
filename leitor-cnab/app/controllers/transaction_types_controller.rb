class TransactionTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transaction_type.save
        format.html { redirect_to transaction_type_url(@transaction_type), notice: "Transaction type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @transaction_type.update(transaction_type_params)
        format.html { redirect_to transaction_type_url(@transaction_type), notice: "Transaction type was successfully updated." }
  ...
  private
    ...
    def transaction_type_params
      params.require(:transaction_type).permit(:identifier, :name, :operation)
    end
end
