...
class TransactionTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_type" do
    assert_difference("TransactionType.count") do
      post transaction_types_url, params: { transaction_type: { identifier: @transaction_type.identifier, name: @transaction_type.name, operation: @transaction_type.operation } }
    end
  ...
  test "should update transaction_type" do
    patch transaction_type_url(@transaction_type), params: { transaction_type: { identifier: @transaction_type.identifier, name: @transaction_type.name, operation: @transaction_type.operation } }
